  ...
  return (
    <div className={depth > 0 ? "ml-8 mt-3" : ""}>
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-2">
          <button
            ...
            className={`flex items-center gap-1 transition-colors ${
              post.upvotedBy?.includes(username) ? "text-purple-700" : "text-gray-500 hover:text-purple-600"
            }`}
          >
            <ThumbsUp className={`${post.upvotedBy?.includes(username) ? "fill-purple-600" : ""} w-4 h-4`} />
        ...
        {isReplying && (
          <div className="mt-4 bg-purple-50 p-4 rounded-2xl">
            <Textarea
